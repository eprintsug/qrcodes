...
document.observe("dom:loaded",function(){
	...
	// Our DOIs render as links.  If yours don't you'll want to add the prefix https://doi.org/ here to make the DOI into a link
	if (doilink) {
...
*/
			...
			var predicteddoi = "https://doi.org/[your prefix]/[Any other part of the generated DOI that is fixed]" + epid;
